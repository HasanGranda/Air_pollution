...
setwd("C:/Users/soldi/Documents/datasciencecoursera/datasciencecoursera/Peer-graded Assignment Air Pollution")
...
#  live stop function terminate the program
...
# zipfile.data and unzip the zipfile.data
